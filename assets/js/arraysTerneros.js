...
function generadorAutomatico() {
    Animales.push(new Animal("ternero","LN738", "532", "CARETA", "VIEJA", "0"))
    Animales.push(new Animal("ternero","LN738", "813", "COLORADA", "VIEJA","0"))
    Animales.push(new Animal("ternero","LN738", "818", "CARETA-COL", "VIEJA","8"))
    Animales.push(new Animal("ternero","LN738", "805", "NEGRA", "VIEJA","9"))
    Animales.push(new Animal("ternero","LN738", "526", "CARETA", "VIEJA","0"))
    Animales.push(new Animal("ternero","LN738", "535", "CARETA", "VIEJA","0"))
    Animales.push(new Animal("ternero","LN738", "539", "COLORADA", "VIEJA","0"))
}
